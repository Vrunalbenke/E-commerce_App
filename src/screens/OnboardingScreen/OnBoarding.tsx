      ...
      <Onboarding
        ...
        pages={[
          ...
          },
          {
            ...
            subtitle:
              'With our app, you can visualize and plan your dream home effortlessly. Use our innovative room planner to arrange and experiment with different furniture layouts. Your creativity knows no bounds, and neither does our app.',
          },
          {
            backgroundColor: color.white,
            image: (
            ...
            title: 'Stay Inspired',
            subtitle:
              "Our app isn't just for shopping; it's a source of inspiration. Follow your favorite designers, explore trending styles, and discover tips and tricks for interior design. Let us keep you inspired on your journey to create a space you'll love.",
          },
          {
            backgroundColor: color.white,
            image: (
            ...
            subtitle:
              "Shop for furniture with confidence using our app. We offer a wide selection of high-quality, durable pieces from trusted brands. With user reviews and expert recommendations, you'll always make informed choices when furnishing your home.",
          },
        ]}
      />
    </View>
