...
let totalPrice = commafy(CartData.total)
  ...
  const radioData = [
    {label: 'UPI', value: 'UPI', index: 0, data: {UPI},text:'Pay by any UPI app'},
    {
    ...
    {label: 'Credit/Debit/ATM Card', value: 'Credit/Debit/ATM Card', index: 2,text:'Add and secure your card as per RBI guidelines'},
    {label: 'Net Banking', value: 'Net Banking', index: 3,text:'This instrument has low success, use UPI or cards for better experience'},
              ...
              <View key={i} style={{flexDirection:'row',justifyContent:'space-between',paddingVertical:10}}>
                <RadioButton labelHorizontal={true} key={i} style={{flexDirection:'column'}}>
                  ...
                  <RadioButtonLabel
                    ...
                    // onPress={onPress}
                    labelStyle={{fontSize: 22,fontWeight:'600',paddingTop:1, color: '#000000'}}
                    labelWrapStyle={{}}
                  />
                  </View>
